...
const Entry kEs[] = {
    ...
    { "Connection timeout. Press B to select another source.", "Tiempo de conexión agotado. Presiona Y para reintentar o B para volver." },
    { "Failed to load stream (network or link error).", "Error al cargar el stream (error de red o enlace caído)." },
    { "Retrying stream...", "Reintentando stream..." },
    { "Reconnecting to stream...", "Reconectando al stream..." },
    { "Connecting to stream...", "Conectando al stream..." },
    { "Streaming via Debrid / HTTP", "Transmitiendo vía Debrid / HTTP" },
...
const Entry kFr[] = {
    ...
    { "Press B to return", "Appuyez sur B pour revenir" },
    { "Press Y to retry  •  Press B to go back", "Appuyez sur Y pour réessayer  •  B pour revenir" },
    { "Press Y to retry  •  Press B to return", "Appuyez sur Y pour réessayer  •  B pour revenir" },
    { "Press Y to retry or B to return.", "Appuyez sur Y pour réessayer ou B pour revenir." },
    { "Connection timeout. Press Y to retry or B to return.", "Délai de connexion dépassé. Appuyez sur Y pour réessayer ou B pour revenir." },
    { "Connection timeout. Press B to select another source.", "Délai de connexion dépassé. Appuyez sur Y pour réessayer ou B pour revenir." },
    { "Failed to load stream (network or link error).", "Échec du chargement du flux (erreur réseau ou lien mort)." },
    { "Retrying stream...", "Nouvelle tentative du flux..." },
    { "Reconnecting to stream...", "Reconnexion au flux..." },
    { "Connecting to stream...", "Connexion au flux..." },
    { "Streaming via Debrid / HTTP", "Lecture via Debrid / HTTP" },
    { "Taking longer than usual... Press Y to retry", "Plus long que d'habitude... Appuyez sur Y pour réessayer" },
